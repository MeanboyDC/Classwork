  ...
  return (
    <div className='about'>
        ...
        <p>Embark on a transformative educational journey with our university's comprehensive
            ...
            the knowledge, skills and experiences needed to excel in the dynamic fielf of education
        </p>
        <p>
        ...
        <p>
            Whether you aspire pathway to achieve your goals and unlock your full potential in shaing the future of education.
        </p>
        </div>
    </div>
  )
